...
export default function SocialLinks({ className = '' }) {
   return (
      <div className={`social-links ${className}`} aria-label="Liên kết mạng xã hội">
         <a className="social-btn" href="https://www.facebook.com/greenshield.mekong" target="_blank" rel="noopener noreferrer" aria-label="Facebook" title="Facebook" data-tooltip="Facebook">
         ...
         <a className="social-btn" href="https://www.tiktok.com/@greenshield.mekong" target="_blank" rel="noopener noreferrer" aria-label="TikTok" title="TikTok" data-tooltip="TikTok">
